...
import (
	entity "Neo/Workplace/goland/src/GeekGo/webook/internal/repository/dao/entity"
	context "context"
	reflect "reflect"
...
func (m *MockUserDAO) FindById(ctx context.Context, id int64) (entity.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserDAO) FindByPhone(ctx context.Context, phone string) (entity.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserDAO) FindByWechat(ctx context.Context, openID string) (entity.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserDAO) Insert(c context.Context, u entity.User) error {
	m.ctrl.T.Helper()
