...
import (
	domain "Neo/Workplace/goland/src/GeekGo/webook/internal/domain"
	context "context"
	reflect "reflect"
...
func (m *MockUserService) Login(c context.Context, u domain.User) (domain.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Login", c, u)
	ret0, _ := ret[0].(domain.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserServiceMockRecorder) Login(c, u any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Login", reflect.TypeOf((*MockUserService)(nil).Login), c, u)
}
